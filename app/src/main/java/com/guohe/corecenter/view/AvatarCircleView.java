...
/**
 * Created by SouKou on 2018/1/9.
 */

public class AvatarCircleView extends CachedImageView {
    ...
    public AvatarCircleView(Context context, AttributeSet attrs, int defStyle) {
