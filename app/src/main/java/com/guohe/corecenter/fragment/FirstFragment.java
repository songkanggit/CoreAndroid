...
//        fragment.setArguments(args);
    ...
    protected void init() {
        ...
        moment.setImageUrl(DomainConst.PICTURE_DOMAIN + "/ImageCache/23c19b652c27451eb1f8e525920180bf.jpg");
        moment.setAccountNickName("超能拳拳酱");
        moment.setContent("#晒娃大赛#");
        moment.setFavorite("11");
        mMomentList.add(moment);
        moment = new Moment();
        moment.setImageUrl(DomainConst.PICTURE_DOMAIN + "/ImageCache/9680299b049d466dbd0e330fe9987fcd.jpg");
